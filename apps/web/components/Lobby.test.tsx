...
const room: RoomSummary = {
  ...
  hostId: "host",
  players: [
    { id: "host", username: "Aanya", isHost: true, isReady: true, isEliminated: false, isSpectator: false, score: 0, colorIndex: 0 },
...
describe("Lobby", () => {
  ...
  it("shows kick buttons + Start only to the host", () => {
    ...
    const three: RoomSummary = {
      ...room,
      players: [
        { id: "host", username: "Aanya", isHost: true, isReady: false, isEliminated: false, isSpectator: false, score: 0, colorIndex: 0 },
        { id: "p2", username: "Rex", isHost: false, isReady: false, isEliminated: false, isSpectator: false, score: 0, colorIndex: 0 },
        { id: "p3", username: "Mo", isHost: false, isReady: false, isEliminated: false, isSpectator: false, score: 0, colorIndex: 0 },
      ],
    };
  ...
  it("disables Start under quorum and emits start when clicked", () => {
    ...
    const three: RoomSummary = {
      ...two,
      players: [...two.players, { id: "p3", username: "Mo", isHost: false, isReady: false, isEliminated: false, isSpectator: false, score: 0, colorIndex: 0 }],
    };
  ...
  it("shows the host-now notice when host migrates to me", () => {
    ...
    const migrated: RoomSummary = {
      ...room,
      hostId: "p2",
      players: [{ id: "p2", username: "Rex", isHost: true, isReady: false, isEliminated: false, isSpectator: false, score: 0, colorIndex: 0 }],
    };
